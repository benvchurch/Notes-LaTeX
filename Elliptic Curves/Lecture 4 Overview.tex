...
so this new map agrees with our prior definition hitting the affine patch $\C^2 \subset \CP^2$. However, when $z = 0$, the power of $z^3$ cancels of the poles of $\wp(z)$ and $\wp'(z)$. To see this recall the expansions,
\[ \wp(z) = \frac{1}{z^2} + \sum_{k 
