...
\begin{proof}
See \chref{https://stacks.math.columbia.edu/tag/06QH}{Tag 06QH}. 
\end{proof}
...
\begin{center}
\begin{tikzcd}
\Spec{\kappa(u)} \arrow[rd] \arrow[r] & \cZ \arrow[d] \arrow[r] & \X
\\
& \G_x \arrow[ru]
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
\B_k G_{\bar{x}} \arrow[d] \arrow[r] & \G_x \arrow[d] \arrow[r, hook] & \X
\\
\Spec{k} \arrow[ru, dashed] \arrow[r] & \Spec{\kappa(x)}
\end{tikzcd}
\end{center}
\end{enumerate}
\end{prop}
