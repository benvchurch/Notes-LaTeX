...
\begin{center}
\begin{tikzcd}
\Ext{i}{A}{A/I}{M / x_1 M} \arrow[r] & \Ext{i+1}{A}{A/I}{M} \arrow[r, "x_1"] & \Ext{i+1}{A}{A}{M} \arrow[r] & \Ext{i+1}{A}{A/I}{M/x_1 M}
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
H^i_I(M / x_1 M) \arrow[r] & H^{i+1}_I(M) \arrow[r, "x_1"] & H^{i+1}_I(M) \arrow[r] & H^{i+1}_I(M/x_1 M)
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
0 \arrow[r] & \H^0_Z(\G) \arrow[r] & \G \arrow[r] & j_* j^* \G \arrow[r] & 0
\end{tikzcd}
\end{center}
and therefore the long exact sequence for $H^0_x(-)$ gives,
\begin{center}
\begin{tikzcd}
0 \arrow[r] & H^0_x(\G) \arrow[r] & H^0_x(\G) \arrow[r] & H^0_x(j_* j^* \G) \arrow[r] & H^1_x(\H^0_Z(\G)) \arrow[r] & 0
\end{tikzcd}
\end{center}
