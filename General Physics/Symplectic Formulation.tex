...
\begin{center}
\begin{tikzcd}
0 \arrow[r] & H^0_{\dR}(M) \arrow[r] & C^\infty(M) \arrow[r, "f \mapsto X_f"] & \ham \arrow[r] & 0
\\
0 \arrow[r] & \ham \arrow[r] & \sym \arrow[r, "X \mapsto \iota_X \omega"] & H^1_{\dR}(M) \arrow[r] & 0
\end{tikzcd}
\end{center}
\end{prop}
...
\begin{center}
\begin{tikzcd}
 & C^{\infty}(M) \arrow[d, "\varphi"]
\\
\g \arrow[ru, "q"] \arrow[r, "\rho"'] & \sym^\op
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}
0 \arrow[r] & \R \arrow[r] & \tilde{\g} \arrow[r] & \R^{2n} \arrow[r] & 0
\end{tikzcd}
\end{center} 
