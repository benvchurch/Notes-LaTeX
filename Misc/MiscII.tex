...
\begin{center}
\begin{tikzcd}[row sep = large, column sep = large]
Z_f \arrow[dr, phantom, "\usebox\pullback" , very near start, color=black] \arrow[d] \arrow[r] & Z  \arrow[d]
\\
X \arrow[r, "f"] & \P(V)
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}[row sep = large, column sep = large]
(Z_f)_x \arrow[dr, phantom, "\usebox\pullback" , very near start, color=black] \arrow[d, hook] \arrow[r] & Z_x \arrow[dr, phantom, "\usebox\pullback" , very near start, color=black] \arrow[d, hook] \arrow[r] & \Spec{\kappa(x)} \arrow[d, hook]
\\
Z_f \arrow[dr, phantom, "\usebox\pullback" , very near start, color=black] \arrow[d] \arrow[r] & Z  \arrow[d] \arrow[r] & \P(V^*) 
\\
X \arrow[r, "f"] & \P(V)
\end{tikzcd}
\end{center}
