...
\begin{enumerate}
\item \sout{$\kappa(X) = - \infty$ and modified PS14}
\item \sout{ample $\Omega^1_X$ and Shioda}
\item Fermat torsion-orders and de Rham Witt cohomology
\item \sout{relative Beauville-Bogomolov}
\item \sout{deforming genus $1$ fibrations to obstruct them}
\item applying unramified classes to obstructing rational endomorphisms
\end{enumerate}
