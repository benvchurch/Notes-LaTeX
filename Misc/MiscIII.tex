...
\begin{defn}
Let $f : \F \to \G$ be a morphism in a topos $\E$. Then $f$ is a \textit{cover} if $f$ is an epimorphism. We say that a family $\{ \F_\alpha to \G \}$ is a cover if $\sqcup \F_\alpha \to \G$ is.
\end{defn}
