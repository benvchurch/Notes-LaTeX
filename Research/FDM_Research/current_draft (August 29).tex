...
\end{equation}
Stars oscillating vertically through the disk are acted on by a graviational acceleration and corresponding gravitational potential,
\begin{subequations}
\begin{align}
...
\begin{subequations}
\begin{align}
\sigma_{10} &= \left( \cdot (\SI{10}{\giga \year}) \deriv{\sigma_D^2}{t} \right)^{1/2}  
\\
...
\deriv{\sigma_D^2}{t} = \frac{8 \pi G^2}{\sqrt{2} \: \sigma_H} \int_0^{M} T_R(m)^2  \deriv{n}{m}  \ln{\left( \frac{\sigma_H \sigma_D}{4 \pi G \Sigma \: r_{\text{t}}(m)} \right)} \d{m},
\end{equation}   
